...
const BS_CALENDAR_DATA = {
    ...
    2083: [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30], // 366 days
...
/**
 * Get day of week for BS date
 */
function getDayOfWeek(bsYear, bsMonth, bsDay) {
    const adDate = bsToAd(bsYear, bsMonth, bsDay);
    const dayNames = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'];
    return dayNames[adDate.date.getDay()];
}
