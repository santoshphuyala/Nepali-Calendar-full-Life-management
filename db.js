...
const medicineDB = new DBManager('medicines');

const familyMembersDB = new DBManager('familyMembers');

const prescriptionsDB = new DBManager('prescriptions');

const dosageScheduleDB = new DBManager('dosageSchedule');
...
// Expose database objects to window for global access

window.holidayDB = holidayDB;

window.incomeDB = incomeDB;
...
window.billDB = billDB;

window.goalDB = goalDB;

window.recurringDB = recurringDB;

window.insuranceDB = insuranceDB;

window.vehicleDB = vehicleDB;

window.vehicleServiceDB = vehicleServiceDB;
...
window.familyMembersDB = familyMembersDB;

window.prescriptionsDB = prescriptionsDB;

window.dosageScheduleDB = dosageScheduleDB;
